...
log_correlator_squared = log_sum_exp(2*log_correlators + entropies)-log_sum_exp(entropies)
...
print(f"Range of correlator: {np.exp(log_correlator)} +/- {np.exp(log_correlator)*log_correlator_err_est}")