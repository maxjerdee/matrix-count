...
plt.clf()
plt.figure()
plt.errorbar(alphas, estimate_mult_err_frac_median, yerr=[estimate_mult_err_frac_median - estimate_mult_err_frac_lower, estimate_mult_err_frac_upper - estimate_mult_err_frac_median], label="Binary Multinomial Estimate")
plt.errorbar(alphas, estimate_DM_err_frac_median, yerr=[estimate_DM_err_frac_median - estimate_DM_err_frac_lower, estimate_DM_err_frac_upper - estimate_DM_err_frac_median], label="Binary DM Estimate")
...
plt.clf()
plt.figure()
plt.errorbar(alphas, estimate_2_err_frac_median, yerr=[estimate_2_err_frac_median - estimate_2_err_frac_lower, estimate_2_err_frac_upper - estimate_2_err_frac_median], label="Multigraph Estimate 2nd Order")
plt.errorbar(alphas, estimate_3_err_frac_median, yerr=[estimate_3_err_frac_median - estimate_3_err_frac_lower, estimate_3_err_frac_upper - estimate_3_err_frac_median], label="Multigraph Estimate 3rd Order")
plt.axvline(x=1, color='r', linestyle='--')
plt.xscale("log")
plt.xlabel(r'$\alpha$')
plt.yscale("symlog", linthresh=1e-4)
